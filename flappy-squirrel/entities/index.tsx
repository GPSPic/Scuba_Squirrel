...
export default (restart: any) => {
    ...
    return{
        ...
        Squirrel: Squirrel(world, 'orange',{x:screenWidth/2, y:screenHeight/2}, {height: 100, width:50}),
        ...
        WallLeft1: Wall(world, 'brown',{x:0, y:screenHeight/2}, {height: screenHeight*3, width: 2}),
        WallRight1: Wall(world, 'brown',{x:screenWidth, y:screenHeight/2}, {height: screenHeight*3, width: 2}),
